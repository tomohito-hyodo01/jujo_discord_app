...
class TypeSelect(discord.ui.Select):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        try:
            ...
            view = PairSelectView(self.tournament_id, selected_type, players, discord_id)
...
class PairSelectView(discord.ui.View):
    ...
    def __init__(self, tournament_id: str, selected_type: str, players: List[Dict[str, Any]], discord_id: str):
        super().__init__(timeout=300)
        self.add_item(PairSelect(tournament_id, selected_type, players, discord_id))
        self.add_item(CancelButton())
...
class PairSelect(discord.ui.Select):
    ...
    def __init__(self, tournament_id: str, selected_type: str, players: List[Dict[str, Any]], discord_id: str):
        ...
        # アクセス者自身を除外した選手リスト
        filtered_players = [p for p in players if p.get('discord_id') != discord_id]
        ...
        options = [
            ...
            for p in filtered_players[:24]  # 最大24個（「その他」用に1枠残す）
        ]
