...
const E_SNIPER = '/game/run/enemy_sniper.png?v=4'  // 「初代サウスポー・アズマ」（ブタメンTシャツの選手）。主人公と同じチビ頭身で再生成＝サイズ感を統一
const E_TENNIS = '/game/run/enemy_tennis.png?v=4'  // 鈴木選手（一般男子優勝）。主人公と同じチビ頭身で再生成＝サイズ感を統一
