...
const E_SWORD = '/game/run/enemy_sword.png?v=1'
      ...
      if (playing) {
        ...
        if (st.nextSpawnT <= 0) {
          ...
          if (enemyKinds.length && Math.random() < 0.3) {
            ...
            else if (type === 'sword') { const h = heroH * 0.92; st.enemies.push({ x: W + 30, w: h * 0.8, h, type, vx: SCROLL * 0.1, aimT: 0, aiming: false, fired: true, bob: 0 }) }
