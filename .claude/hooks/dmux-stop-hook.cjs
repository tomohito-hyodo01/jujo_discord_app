...
process.stdin.on('end', () => {
  ...
  const event = {
    ...
    expectedDmuxPaneId: 'dmux-1782483504636',
  ...
  try {
    fs.writeFileSync('/Users/hyodo/discord/jujo_discord_app/.dmux/worktrees/dmux-2026-06-26-231823/.claude/dmux/dmux-1782483504636.json', JSON.stringify(event, null, 2));
  } catch (error) {
    process.exit(0);
  }
